...
function theEND() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/death.webp")`;
}
function toVillage() {
...
function toDemonKingCastle() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/demon_king.jpg")`;
}
function fightDemonKing() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/victory.jfif")`;
            break;
...
function helpVillagers() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/forest.jpg")`;
}
function pressDeeper() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/mountain.jfif")`;
}
function camp() {
...
function hiddenPath() {
    ...
    document.querySelector('.image-box').style.backgroundImage = `url("../img/priestess.jpg")`;
}
function answer16() {
